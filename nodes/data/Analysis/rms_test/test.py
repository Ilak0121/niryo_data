...
path1 = '/home/ilak/workspace/lab_repo/nodes/data/data_stack/printer/print_collision/print_collision_data/'
path2 = '/home/ilak/workspace/lab_repo/nodes/data/data_stack/printer/print_normal/print_normal_data/'
for i in range(1,101):
    rms1=rms2=0
    #mean1=mean2=0
    
    fd1 = pd.read_csv(path1+'collision'+str(i)+'.csv')
    fd2 = pd.read_csv(path2+'normal'+str(i)+'.csv')
