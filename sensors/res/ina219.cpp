/*INA219 hi-side i2c current/power monitor Library
 *
...
#endif
    write16(CONFIG_R, config); //chage needing
}

#define INA_RESET        0xFFFF    // send to CONFIG_R to reset unit
void INA219::reset(){
    write16(CONFIG_R, INA_RESET);//change needing
    _delay_ms(5);
}
